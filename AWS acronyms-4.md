...
**ECS**-***Elastic Container Service*** is the container orchestration service for running stateless and stateful containers using **tasks** and **services**.  You will find 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE2MDE1NDU4NSwtNjkzNzA4NDExLDE4Nj
U1MTYwNjBdfQ==
-->